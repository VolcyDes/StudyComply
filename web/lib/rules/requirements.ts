...
const UK_ALL: RequirementDef[] = [
  ...
  },
  {
    ...
    description: "Pour les séjours d'études inférieurs à 6 mois au Royaume-Uni (ex. semestre d'échange, cours intensifs). Plus simple et moins coûteux que le Student Route.",
    icon: "📋",
    daysBeforeDeparture: -60,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
...
const JAPAN_ALL: RequirementDef[] = [
  {
    ...
    description: "L'université japonaise doit demander le COE au bureau d'immigration japonais en ton nom. Ce document est nécessaire pour obtenir le visa étudiant. Compter 1 à 3 mois de délai.",
    icon: "🎓",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
