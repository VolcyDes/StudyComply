...
export type RequirementDef = {
   ...
   * e.g. "Requis pour les séjours > 90 jours"
   */
  durationNote?: string;
};
...
const COMMON: RequirementDef[] = [
  ...
  },
  {
    ...
    description: "Indispensable pour recevoir bourses, payer le loyer et un job étudiant. Prévoir 2–4 semaines après l'arrivée. Certaines banques (Wise, N26, Revolut) permettent d'ouvrir avant le départ.",
    icon: "🏦",
    ...
    linkLabel: "Ouvrir un compte Wise (multi-devises)",
  },
];
...
const SCHENGEN_EU_EEA: RequirementDef[] = [
  ...
  },
  {
    ...
    description: "Donne accès aux soins d'urgence dans tous les pays UE/EEA aux mêmes tarifs que les résidents. Gratuite, demandée auprès de ta caisse d'assurance maladie (Ameli en France).",
    icon: "🏥",
    ...
    linkLabel: "Demander la CEAM sur Ameli.fr",
  ...
  },
  {
    ...
    linkLabel: "Guide officiel enregistrement — Europa.eu",
    note: "Délai variable : 8 jours en Belgique, 3 mois en France, 3 mois en Espagne.",
    minStayDays: 91,
    durationNote: "Uniquement pour les séjours > 3 mois",
  },
];
...
const SCHENGEN_NON_EU: RequirementDef[] = [
  ...
  },
  {
    ...
    minStayDays: 91,
    durationNote: "Requis pour les séjours > 90 jours (visa D)",
  },
  {
    id: "visa_student_d",
    type: "visa",
    label: "Visa étudiant long séjour (type D)",
    description: "Obligatoire pour tout séjour d'études > 90 jours dans un pays Schengen. Le visa D est national (spécifique au pays) — il ne donne pas accès à tous les pays Schengen comme un visa C.",
    icon: "📋",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["NON_EU"],
    ...
    minStayDays: 91,
    durationNote: "Requis pour les séjours > 90 jours",
  },
  {
    id: "visa_photos_schengen",
    type: "photos",
    label: "Photos d'identité biométriques",
    description: "2 photos au format biométrique (35×45 mm, fond blanc, moins de 6 mois) requises pour le dossier de visa D.",
    icon: "📸",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["NON_EU"],
  ...
  },
  {
    ...
    description: "Obligatoire pour le visa D. Doit couvrir les urgences médicales et le rapatriement pour un minimum de 30 000 € sur toute la durée du séjour.",
    icon: "🏥",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["NON_EU"],
    ...
    linkLabel: "Chapka — Assurance étudiant international",
    note: "Alternatives : AXA Schengen, MACSF, Allianz Travel. Vérifier que la date de début coïncide avec ton arrivée.",
    minStayDays: 91,
    durationNote: "Obligatoire pour l'obtention du visa D",
  },
  {
    ...
    linkLabel: "Campus France — Préparer son dossier",
    minStayDays: 91,
    durationNote: "Requis pour la demande de visa D",
  },
  {
    id: "residence_permit_schengen",
    type: "residence_permit",
    label: "Titre de séjour / Permis de résidence",
    description: "Dans la majorité des pays Schengen, le visa D doit être converti en titre de séjour dans les premiers mois suivant l'arrivée. Exemple : carte de séjour en France (via ANEF), Aufenthaltstitel en Allemagne.",
    icon: "📇",
    daysBeforeDeparture: 60,
    priority: "required",
    tiers: ["NON_EU"],
    ...
    linkLabel: "ANEF — Titre de séjour (France)",
    note: "France : à déposer dans les 4 mois · Allemagne : 3 mois · Espagne : 1 mois · Pays-Bas : dès l'arrivée.",
    minStayDays: 91,
  },
  {
...
const USA_ALL: RequirementDef[] = [
  ...
  },
  {
    ...
    note: "Le délai moyen pour un RDV varie de 2 semaines à 6 mois selon le pays. Vérifier les délais actuels sur travel.state.gov avant de planifier.",
  },
  {
    id: "f1_visa",
    type: "visa",
  ...
  },
  {
    ...
    linkLabel: "Comparer les assurances (ISI)",
    note: "Vérifier si ton université impose son propre plan ou accepte une assurance externe avant de souscrire.",
  },
  {
    id: "usa_ssn",
    type: "ssn",
...
const CANADA_ALL: RequirementDef[] = [
  ...
  },
  {
    ...
    minStayDays: 181,
    durationNote: "Requis pour les séjours > 6 mois (permis d'études)",
  },
  {
    id: "canada_study_permit",
    type: "visa",
    label: "Permis d'études canadien",
    description: "Obligatoire pour les études de plus de 6 mois au Canada. À demander en ligne sur le portail IRCC. Délai de traitement : 4 à 12 semaines.",
    icon: "📋",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    minStayDays: 181,
    durationNote: "Requis pour les séjours > 6 mois",
  },
  {
    ...
    minStayDays: 181,
    durationNote: "Requis pour la demande de permis d'études",
  },
  {
    id: "canada_insurance",
    type: "insurance",
    label: "Assurance santé provinciale / complémentaire",
    description: "La couverture santé varie par province. Certaines (Ontario, C.-B.) couvrent les étudiants internationaux après un délai d'attente. Une assurance privée est indispensable en attendant l'activation.",
    icon: "🏥",
    daysBeforeDeparture: -30,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    linkLabel: "Guide assurance santé étudiants — Canada",
...
const UK_ALL: RequirementDef[] = [
  {
    ...
    description: "Ton université doit t'attribuer un numéro CAS avant que tu puisses demander ton visa étudiant (Student Route). C'est le document de base de toute candidature.",
    icon: "🎓",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    linkLabel: "Visa étudiant UK (Student Route) – GOV.UK",
    minStayDays: 181,
    durationNote: "Requis pour les séjours > 6 mois (Student Route)",
  },
  {
    id: "uk_student_visa",
    type: "visa",
    label: "Visa étudiant UK (Student Route, > 6 mois)",
    description: "Depuis le Brexit, tous les étudiants étrangers (EU inclus) doivent obtenir un Student Visa pour étudier plus de 6 mois au Royaume-Uni. Pour ≤ 6 mois, un Standard Visitor Visa peut suffire.",
    icon: "📋",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    linkLabel: "Demander le Student Visa – GOV.UK",
    minStayDays: 181,
    durationNote: "Requis pour les séjours > 6 mois. Pour ≤ 6 mois : Standard Visitor Visa",
  },
  {
    id: "uk_eta",
    type: "eta",
    label: "Autorisation de voyage électronique UK (ETA — £10)",
    description: "Depuis le 2 avril 2025, les ressortissants de l'UE/EEE doivent obtenir une ETA avant tout voyage au Royaume-Uni. Coût : £10. Valable 2 ans ou jusqu'à expiration du passeport. Réponse généralement sous 3 jours ouvrables.",
    icon: "✈️",
    daysBeforeDeparture: -30,
    priority: "required",
    tiers: ["EU_EEA"],
    ...
    linkLabel: "Demander l'ETA UK (£10) — GOV.UK",
    note: "Exception : les citoyens irlandais et les détenteurs d'un visa ou d'un titre de séjour UK n'ont pas besoin d'ETA.",
  },
  {
    id: "uk_short_stay_visa",
    type: "visa",
    label: "Standard Visitor Visa (études ≤ 6 mois)",
    description: "Pour les ressortissants non-UE souhaitant étudier moins de 6 mois au Royaume-Uni (ex. semestre d'échange, cours intensifs). Les citoyens UE/EEE n'ont pas besoin de ce visa.",
    icon: "📋",
    daysBeforeDeparture: -60,
    priority: "required",
    tiers: ["NON_EU"],
    ...
    maxStayDays: 180,
    durationNote: "Pour les séjours ≤ 6 mois",
  },
  {
    id: "uk_ihs",
    type: "insurance",
    label: "Surcharge santé (Immigration Health Surcharge — IHS)",
    description: "Frais obligatoires à payer lors de la demande de Student Visa. Environ £776/an. Te donne accès au NHS (National Health Service) pendant ton séjour.",
    icon: "🏥",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    minStayDays: 181,
    durationNote: "Lié au Student Visa (séjours > 6 mois)",
  },
  {
    id: "uk_brp",
    type: "residence_permit",
...
const JAPAN_ALL: RequirementDef[] = [
  {
    ...
    description: "L'université japonaise doit demander le COE au bureau de l'immigration japonais en ton nom. Ce document est indispensable pour obtenir le visa étudiant. Délai de traitement : 1 à 3 mois. Demander à ton université de lancer la procédure dès que possible.",
    icon: "🎓",
  ...
  },
  {
    ...
    description: "Visa à demander auprès du consulat japonais de ton pays avec le COE. Obligatoire pour les séjours d'études supérieurs à 90 jours. Pour ≤ 90 jours, les ressortissants UE peuvent entrer sans visa.",
    icon: "📋",
    daysBeforeDeparture: -60,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
  ...
  },
  {
    ...
    description: "Délivrée automatiquement à l'aéroport à ton arrivée (avec visa étudiant). Conserve-la — demandée pour l'ouverture de compte bancaire, location, etc.",
    icon: "📇",
...
const AUSTRALIA_ALL: RequirementDef[] = [
  {
    ...
    description: "Document émis par ton université australienne après paiement des frais d'inscription. Requis pour la demande de visa étudiant Subclass 500.",
    icon: "🎓",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    linkLabel: "Visa Subclass 500 – DHA Australie",
    minStayDays: 91,
    durationNote: "Requis pour les séjours > 3 mois",
  },
  {
    id: "au_student_visa",
    type: "visa",
    label: "Visa étudiant Australie (Subclass 500)",
    description: "Visa obligatoire pour tous les étudiants étrangers souhaitant étudier plus de 3 mois en Australie. Demande en ligne via ImmiAccount. Pour ≤ 3 mois, le visa touriste (Subclass 600) peut suffire.",
    icon: "📋",
    daysBeforeDeparture: -90,
    priority: "required",
    tiers: ["EU_EEA", "NON_EU"],
    ...
    linkLabel: "Demander le Subclass 500 (ImmiAccount)",
    minStayDays: 91,
    durationNote: "Requis pour les séjours > 3 mois",
  },
  {
  ...
  },
  {
    ...
    description: "Collecte d'empreintes digitales et photo au centre biométrique ou à l'aéroport. Requis pour la plupart des nationalités non-UE.",
    icon: "🔍",
    daysBeforeDeparture: -60,
    priority: "required",
    tiers: ["NON_EU"],
