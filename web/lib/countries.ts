/**
 * Complete list of all UN-recognized countries + territories commonly used
 * as travel documents, sorted alphabetically by French name.
...
export const ALL_COUNTRIES: Country[] = [
  ...
  // Territoires avec documents de voyage reconnus
  { code: "TW", name: "Taïwan" },
  { code: "PS", name: "Palestine" },
  { code: "XK", name: "Kosovo" },
  { code: "HK", name: "Hong Kong (RAS)" },
  { code: "MO", name: "Macao (RAS)" },
];
