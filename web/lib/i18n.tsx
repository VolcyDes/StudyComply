...
export const TRANSLATIONS = {
  fr: {
    ...
    student: {
      ...
      // Purpose labels
      purposeExchange:    "Échange universitaire",
      purposeInternship:  "Stage",
      purposeDegree:      "Diplôme",
      purposePhd:         "Doctorat",
      purposeLanguage:    "Cours de langue",
      // Document type labels
      docPassport:        "🛂 Passeport",
      docVisa:            "📋 Visa",
      docInsurance:       "🏥 Assurance",
      docAcceptance:      "🎓 Acceptation",
      docTranscript:      "📄 Relevé",
      docAccommodation:   "🏠 Logement",
      docFunds:           "💰 Ressources",
      docPhotos:          "📸 Photos",
      docAppointment:     "📅 Rendez-vous",
      docResidencePermit: "📇 Titre de séjour",
      docBank:            "🏦 Banque",
      docEnrollment:      "✏️ Inscription",
      docRegistration:    "🏛️ Enregistrement",
      docI20:             "📋 Formulaire I-20",
      docSevisFee:        "💳 Taxe SEVIS",
      docDs160:           "💻 Formulaire DS-160",
      docEta:             "✈️ Autorisation ETA",
      docPal:             "📜 Lettre PAL/CAQ",
      docSsn:             "🪪 Numéro SSN",
      docSin:             "🪪 Numéro NAS",
    ...
    profile: {
      ...
      passChoosePlaceholder:  "Choisir un pays…",
      passSearchPlaceholder:  "Rechercher un pays ou un code…",
      passNotFound:           "Aucun pays trouvé",
      passDeleteDesc:         "Le passeport {country} sera retiré de ton profil. Cette action est réversible.",
      passNationality:        "Nationalité du passeport",
      passDescFull:           "Ajoute tous les passeports que tu possèdes. StudyComply les utilise pour calculer les documents et visas dont tu as besoin selon ta destination.",
      passDuplicate:          "Ce passeport est déjà dans ta liste.",
      passAlreadyIn:          "{country} est déjà dans ta liste de passeports.",
      passAdded:              "Passeport ajouté !",
      passDeleted:            "Passeport supprimé.",
      passAddBtn:             "Ajouter",
      passAddedAlready:       "✓ Déjà dans ta liste",
      ...
      univInfoName:           "Nom de l'établissement",
      univInfoNameEx:         "Ex : Université Paris-Saclay",
      univInfoCountry:        "Pays",
      univInfoCountryEx:      "Ex : France",
      univInfoWebsite:        "Site web",
      univInfoWebsiteEx:      "Ex : https://universite.fr",
      univInfoId:             "Numéro SIRET / identifiant",
      univInfoIdEx:           "Ex : 12345678900012",
      univContactName:        "Nom du responsable",
      univContactNameEx:      "Ex : Marie Dupont",
      univContactPhone:       "Téléphone",
      univContactPhoneEx:     "Ex : +33 1 23 45 67 89",
      univProgsDev:           "Fonctionnalité en développement",
      univProgsDesc:          "Gérez vos universités partenaires, programmes Erasmus+ et accords bilatéraux directement ici.",
      univNotif1Label:        "Alertes documents expirés",
      univNotif1Desc:         "Notifier quand un document étudiant expire",
      univNotif2Label:        "Rappels de conformité",
      univNotif2Desc:         "Résumé hebdomadaire du taux de conformité",
      univNotif3Label:        "Nouveaux étudiants",
      univNotif3Desc:         "Notifier à l'arrivée d'un nouvel étudiant",
      // Personal info section (student)
      personalTitle:          "Informations personnelles",
      personalName:           "Prénom & nom",
      personalNameEx:         "Ex : Jean Dupont",
      personalDob:            "Date de naissance",
      personalDobEx:          "Ex : 01/01/2000",
      personalUniv:           "Université d'origine",
      personalUnivEx:         "Ex : Université de Bordeaux",
      // Student notifications
      studNotif1Label:        "Expiration de documents",
      studNotif1Desc:         "Rappel 60 jours avant l'expiration",
      studNotif2Label:        "Nouvelles exigences",
      studNotif2Desc:         "Alerte si les règles de ta destination changent",
      // Account section
      accountTitle:  "Compte",
      email:         "Adresse email",
      role:          "Rôle",
  ...
  en: {
    ...
    student: {
      ...
      // Purpose labels
      purposeExchange:    "University exchange",
      purposeInternship:  "Internship",
      purposeDegree:      "Degree",
      purposePhd:         "PhD",
      purposeLanguage:    "Language course",
      // Document type labels
      docPassport:        "🛂 Passport",
      docVisa:            "📋 Visa",
      docInsurance:       "🏥 Insurance",
      docAcceptance:      "🎓 Acceptance letter",
      docTranscript:      "📄 Transcript",
      docAccommodation:   "🏠 Accommodation",
      docFunds:           "💰 Proof of funds",
      docPhotos:          "📸 Photos",
      docAppointment:     "📅 Appointment",
      docResidencePermit: "📇 Residence permit",
      docBank:            "🏦 Bank account",
      docEnrollment:      "✏️ Enrollment",
      docRegistration:    "🏛️ Registration",
      docI20:             "📋 Form I-20",
      docSevisFee:        "💳 SEVIS fee",
      docDs160:           "💻 Form DS-160",
      docEta:             "✈️ ETA authorization",
      docPal:             "📜 PAL/CAQ letter",
      docSsn:             "🪪 SSN",
      docSin:             "🪪 SIN",
    ...
    profile: {
      ...
      passChoosePlaceholder:  "Choose a country…",
      passSearchPlaceholder:  "Search a country or code…",
      passNotFound:           "No country found",
      passDeleteDesc:         "The {country} passport will be removed from your profile. This can be undone.",
      passNationality:        "Passport nationality",
      passDescFull:           "Add all the passports you hold. StudyComply uses them to determine the documents and visas you need for your destination.",
      passDuplicate:          "This passport is already in your list.",
      passAlreadyIn:          "{country} is already in your passport list.",
      passAdded:              "Passport added!",
      passDeleted:            "Passport deleted.",
      passAddBtn:             "Add",
      passAddedAlready:       "✓ Already in your list",
      ...
      univInfoName:           "Institution name",
      univInfoNameEx:         "E.g. Paris-Saclay University",
      univInfoCountry:        "Country",
      univInfoCountryEx:      "E.g. France",
      univInfoWebsite:        "Website",
      univInfoWebsiteEx:      "E.g. https://university.edu",
      univInfoId:             "SIRET / identifier",
      univInfoIdEx:           "E.g. 12345678900012",
      univContactName:        "Contact name",
      univContactNameEx:      "E.g. Jane Smith",
      univContactPhone:       "Phone",
      univContactPhoneEx:     "E.g. +33 1 23 45 67 89",
      univProgsDev:           "Feature in development",
      univProgsDesc:          "Manage your partner universities, Erasmus+ programmes and bilateral agreements directly here.",
      univNotif1Label:        "Expired document alerts",
      univNotif1Desc:         "Notify when a student document expires",
      univNotif2Label:        "Compliance reminders",
      univNotif2Desc:         "Weekly compliance rate summary",
      univNotif3Label:        "New students",
      univNotif3Desc:         "Notify when a new student arrives",
      // Personal info section (student)
      personalTitle:          "Personal information",
      personalName:           "Full name",
      personalNameEx:         "E.g. John Smith",
      personalDob:            "Date of birth",
      personalDobEx:          "E.g. 01/01/2000",
      personalUniv:           "Home university",
      personalUnivEx:         "E.g. University of Southampton",
      // Student notifications
      studNotif1Label:        "Document expiration",
      studNotif1Desc:         "Reminder 60 days before expiration",
      studNotif2Label:        "New requirements",
      studNotif2Desc:         "Alert if the rules for your destination change",
      // Account section
